...
vector<TestCase>
        testCases = {
        {"sorteren van vijf willekeurige positieve eenheden",
                {5,4,3,2,1}},
        {"sorteren van willekeurige positieve eenheden",
                {9, 3, 5, 7, 1, 8, 2, 6, 4, 0}},
        {"sorteren van willekeurige positieve eenheden en tientallen",
                {99, 59, 5, 71, 60, 63, 32, 79, 63, 0}},
        {"sorteren van willekeurige positieve eenheden, tientallen en honderdtallen",
                {999,  8,    176,  54,  87,  471,  24,   122,  538,  0}},
        {"sorteren van willekeurige negatieve eenheden",
                {-9,   0,    -9,   -2,  -5,  -9,   0,    -1,   -5,   -9}},
        {"sorteren van willekeurige negatieve eenheden en tientallen",
                {-61,  -39,  -9,   -46, -68, -13,  -68,  -13,  -61,  -96}},
        {"sorteren van willekeurige positieve en negatieve eenheden, tientallen en honderdtallen",
                {-720, -485, -1,   -52, -89, -134, -206, -165, -887, -755}},
        {"sorteren van willekeurige positieve en negatieve eenheden",
                {6,    -5,   2,    -4,  -1,  -1,   9,    -9,   6,    -2}},
        {"sorteren van willekeurige positieve en negatieve eenheden en tientallen",
